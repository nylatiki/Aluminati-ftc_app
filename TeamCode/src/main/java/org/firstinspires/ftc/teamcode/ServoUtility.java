 ...
 */
@TeleOp(name="Servo Utility", group="Testers")
public class ServoUtility extends OpMode
{
    ...
    /*
    Controls:
    Left Bumper: decrease interval
    Right Bumper: increase interval
    X: decrement by the interval
    Y: increment by the interval
    D-Pad:
        Down:   Set position to 0
        Up:     Set position to 1
        Right:  Set position to 0.5
     */
