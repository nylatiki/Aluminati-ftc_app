...
@Autonomous(name="Stupid Auto", group="CompBot")
//@Disabled
public class PlsSomethingWorkAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        // Move Forward
        setNewTarget(70, 0, 0, 70);
        while ( opModeIsActive() &&
                (hardware.flwheel.isBusy() && hardware.brwheel.isBusy()))
        {
